...
kern:
	...
	gcc -m32 -g -ffreestanding -c fs.c -o fs.o

link:
	ld -m elf_i386 -Ttext 0x1000 -o kernel.bin loader.o main.o fs.o $(wildcard include/*.o cpu/*.o user/shell/*.o user/taskbar/*.o)

run:
	qemu-system-x86_64 -kernel kernel.bin
clean:
	rm *.o include/*.o cpu/*.o user/shell/*.o user/taskbar/*.o fs.o
